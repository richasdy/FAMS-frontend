			          ...
			          <div class="col-md-12">
			              ...
			              <div class="portlet box green">
			                <div class="portlet-title">
			                    <div class="caption">
			                        <i class="fa fa-cogs"></i>Gedung's Table</div>
			                    <div class="tools">
			                  ...
			                  <div class="flip-content">
			                    <div class="row">
			                      <div class="col-md-5 col-sm-5">
			                        Showing {{$gedung->from}} to {{$gedung->to}}  from {{$gedung->total}} data
			                      </div>
			                      <div class="col-md-7 col-sm-7">
			                        <div class="dataTables_paginate paging_bootstrap_full_number">
			                          <ul class="pagination">
			                            <li class="prev">
			                              <a href="{{url('gedung?page=1')}}"><i class="fa fa-angle-double-left"></i></a>
			                            </li>
			                            <li class="prev">
			                              <a id="paging-prev" href="{{url('gedung?page=')}}"><i class="fa fa-angle-left"></i></a>
			                            </li>
			                            <li><a id="paging-current">{{$gedung->current_page}}</a></li>
			                            <li class="next">
			                              <a id="paging-next" href="{{url('gedung?page=')}}"><i class="fa fa-angle-right"></i></a>
			                            </li>
			                            <li class="next">
			                              <a href="{{url('gedung?page='.$gedung->last_page)}}"><i class="fa fa-angle-double-right"></i></a>
			                            </li>
			                          </ul>
			                        </div>
			                      </div>
			            ...
			            <div class="modal-dialog">
			              <div class="modal-content">
			                ...
			                <div class="modal-body">
			                  <form action="{{url('create-gedung')}}" method="GET">
								    ...
								    <div class="modal-content">
								      <div class="modal-header">
								        ...
								        <h4 class="modal-title">Delete Gedung</h4>
											...
											<form action="{{url('delete-gedung')}}" method="GET">
								      <div class="modal-body">
