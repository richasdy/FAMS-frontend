			          ...
			          <div class="col-md-12">
			              ...
			              <div class="portlet box green">
			                <div class="portlet-title">
			                    <div class="caption">
			                        <i class="fa fa-cogs"></i>Type's Table</div>
			                    <div class="tools">
			                    ...
			                    <div class="row">
			                      ...
			                      <div class="col-md-7 col-sm-7">
			                        <div class="dataTables_paginate paging_bootstrap_full_number">
			                          <ul class="pagination">
			                            <li class="prev">
			                              <a href="{{url('type?page=1')}}"><i class="fa fa-angle-double-left"></i></a>
			                            </li>
			                            <li class="prev">
			                              <a id="paging-prev" href="{{url('type?page=')}}"><i class="fa fa-angle-left"></i></a>
			                            </li>
			                            <li><a id="paging-current">{{$types->current_page}}</a></li>
			                            <li class="next">
			                              <a id="paging-next" href="{{url('type?page=')}}"><i class="fa fa-angle-right"></i></a>
			                            </li>
			                            <li class="next">
			                              <a href="{{url('type?page='.$types->last_page)}}"><i class="fa fa-angle-double-right"></i></a>
			                            </li>
			                          </ul>
			                        </div>
			                      </div>
			            ...
			            <div class="modal-dialog">
			              <div class="modal-content">
			                ...
			                <div class="modal-body">
			                  <form action="{{url('create-type')}}" method="GET">
								    ...
								    <div class="modal-content">
								      <div class="modal-header">
								        ...
								        <h4 class="modal-title">Delete Location</h4>
											...
											<form action="{{url('delete-type')}}" method="GET">
								      <div class="modal-body">
