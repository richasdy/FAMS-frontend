...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Bandung Techno Park | Management Asset | User Login 1</title>
        ...
        <link href="dashboard_themes/assets/pages/css/login.min.css" rel="stylesheet" type="text/css" />
    </head>
    <!-- END HEAD -->
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <form class="login-form" action="{{url('/login-action')}}" method="post">
        ...
        <div class="copyright"> 2017 © BTP. Management Asset. </div>
